...
class PsyStackActions:
    def __init__(self, app: PsyStackApp, backend: TuiBackendService) -> None:
        self.app = app
        self.backend = backend

    def open_workspace_picker(self) -> None:
        from psystack.tui.screens.workspace_picker import WorkspacePickerModal
    ...
    def switch_case(self) -> None:
        ...
        from psystack.tui.detection import load_recent_cases
