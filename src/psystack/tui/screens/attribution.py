...
from psystack.models.isolation import AttributionTable
from psystack.tui.widgets.causal_sequence import CausalSequence
from psystack.tui.widgets.explanation_card import ExplanationCard
from psystack.tui.widgets.falsifier_list import FalsifierList
from psystack.tui.widgets.tier_indicator import TierIndicator
...
class AttributionWorkspaceScreen(Screen):
    ...
    def on_button_pressed(self, event: Button.Pressed) -> None:
        if event.button.id == "attr-back":
            ...
            self.notify("Export: use 'psystack report' CLI to generate HTML/JSON")
