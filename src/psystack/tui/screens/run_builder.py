...
from psystack.tui.widgets.run_config_panel import RunConfigPanel
...
class RunBuilderScreen(Screen):
    ...
    def _workspace_for_case(self, case: Case) -> Path:
        ...
        return root / ".psystack" / "cases" / case.id
    ...
    def on_button_pressed(self, event: Button.Pressed) -> None:
        if event.button.id == "planner_btn":
            ...
            from psystack.tui.screens.case_history import CaseHistoryModal
