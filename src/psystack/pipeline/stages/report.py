...
from psystack.models.evidence import EvidencePack
...
class ReportStage:
    ...
    def run(self, ctx: RunContext) -> StageResult:
        ...
        from psystack.reporting.renderers.console import print_console_bundle
        from psystack.reporting.renderers.html import write_html_bundle
        from psystack.reporting.renderers.json import write_json_bundle
