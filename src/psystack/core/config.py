"""PsyStack settings: Pydantic-backed config with workspace-explicit loading."""
...
class PsyStackSettings(BaseSettings):
...
def load_settings_from_workspace(workspace: Path) -> PsyStackSettings:
    ...
    with config_path.open("rb") as f:
        raw = tomllib.load(f)
    settings = PsyStackSettings.model_validate(raw)
